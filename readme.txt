...
A https://gobinaries.com alternative

Simply put it's a lot of code that's been picked up from the original https://github.com/tj/gobinaries
...
You can read it in the tree in the file LICENSE
